...
class TimeEntriesControllerTest < ActionController::TestCase
  ...
  test "should create time_entry" do
    assert_difference('TimeEntry.count') do
      post :create, time_entry: { date: @time_entry.date, description: @time_entry.description, hours: @time_entry.hours }
    end
  ...
  test "should update time_entry" do
    put :update, id: @time_entry, time_entry: { date: @time_entry.date, description: @time_entry.description, hours: @time_entry.hours }
    assert_redirected_to time_entry_path(assigns(:time_entry))
  end
